...
import { ArrowLeft, Plus, MessageSquare, FileText, HelpCircle, ImageIcon, Video, Megaphone, TrendingUp, Heart } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20">
      <div className="container mx-auto py-8 px-4">
        {/* 헤더 섹션 */}
        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 sm:p-6 mb-8 border border-white/20 shadow-lg">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex-1 text-center mx-4">
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-slate-800 via-blue-700 to-indigo-700 bg-clip-text text-transparent">
                  {tabContent[activeTab].title}
                </h1>
              </div>
              <p
                className="text-sm text-slate-600 max-w-lg mx-auto leading-relaxed"
            ...
            >
              <Link href="/boards/create" className="flex items-center gap-1">
          ...
          <div className="flex justify-center">
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full max-w-md">
              <TabsList className="grid w-full grid-cols-3 bg-slate-50/80 backdrop-blur-sm">
