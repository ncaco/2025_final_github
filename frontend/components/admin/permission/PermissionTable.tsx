        ...
        <table className="w-full border-collapse table-fixed">
          ...
          <thead className="bg-background">
            <tr>
              ...
              <th className="h-12 p-1 text-center border font-medium text-muted-foreground">권한 ID</th>
              <th className="h-12 p-1 text-center border font-medium text-muted-foreground">권한 코드</th>
              <th className="h-12 p-1 text-center border font-medium text-muted-foreground">권한 이름</th>
        ...
        <table className="w-full border-collapse table-fixed">
          ...
          <tbody>
            {permissions.map((permission, index) => {
              ...
              return (
                <tr key={permission.permission_id} className="border-b transition-colors hover:bg-muted/50">
                  <td className="p-1 border text-center align-middle">{rowNumber}</td>
                  <td className="p-1 border text-center align-middle">{permission.permission_id}</td>
                  <td className="p-1 border text-center align-middle">{permission.permission_cd}</td>
                  <td className="p-1 border text-center align-middle">{permission.permission_nm}</td>
                  ...
                  <td className="p-1 border text-center align-middle">
                    {new Date(permission.crt_dt).toLocaleDateString('ko-KR')}
                  </td>
