...
interface RoleTableProps {
  ...
  loading: boolean;
  onViewRole: (role: RoleWithPermissions) => void;
        ...
        <table className="w-full border-collapse table-fixed">
          ...
          <thead className="bg-background">
            <tr>
              ...
              <th className="h-12 p-1 text-center border font-medium text-muted-foreground">역할 코드</th>
              <th className="h-12 p-1 text-center border font-medium text-muted-foreground">역할 이름</th>
              <th className="h-12 p-1 text-center border font-medium text-muted-foreground">역할 설명</th>
              <th className="h-12 p-1 text-center border font-medium text-muted-foreground">권한 수</th>
        ...
        <table className="w-full border-collapse table-fixed">
          ...
          <tbody>
            {roles.map((role, index) => {
              ...
              return (
                <tr key={role.role_id} className="border-b transition-colors hover:bg-muted/50">
                  <td className="p-1 border text-center align-middle">{rowNumber}</td>
                  <td className="p-1 border text-center align-middle">{role.role_id}</td>
                  <td className="p-1 border text-center align-middle">{role.role_cd || '-'}</td>
                  <td className="p-1 border text-center align-middle">{role.role_nm}</td>
