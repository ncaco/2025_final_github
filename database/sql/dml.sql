...
-- ============================================
-- 주의: ASGN_BY는 외래키 제약조건이 있으므로 NULL 또는 존재하는 USER_ID만 사용 가능
-- 시스템 초기 데이터이므로 ASGN_BY는 NULL로 설정
INSERT INTO COMMON_USER_ROLE (
    USER_ROLE_ID, USER_ID, ROLE_ID, ASGN_BY, ASGN_DT,
    CRT_BY, CRT_BY_NM, USE_YN
) VALUES
('UR_ADMIN_001', 'ADMIN_001', 'ROLE_ADMIN_001', NULL, CURRENT_TIMESTAMP, 'SYSTEM', '시스템', TRUE),
('UR_USER_001', 'USER_001', 'ROLE_USER_001', NULL, CURRENT_TIMESTAMP, 'SYSTEM', '시스템', TRUE)
